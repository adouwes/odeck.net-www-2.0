...
function loadById() {
  ...
  query.find({
    success: function(results){
      ...
      output += "<div class='col-xs-3'>"+username+"</div><div class='col-xs-9'><p class='text-right'>"+m.format("MMM Do YYYY, hh:mm:ss")+"</p></div></div></div><div class='card-image text-center'>";
